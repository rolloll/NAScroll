...
**Current version:** `1.2.4` (`versionCode 7`)
...
1. Download the current APK from the [NAScroll 1.2.4 GitHub Release](https://github.com/rolloll/NAScroll/releases/tag/v1.2.4), or build one locally as described below.
