...
**Current version:** `1.2.3` (`versionCode 6`)
...
1. Download the current APK from the [NAScroll 1.2.3 GitHub Release](https://github.com/rolloll/NAScroll/releases/tag/v1.2.3), or build one locally as described below.
